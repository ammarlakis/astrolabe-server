...
func NewDeploymentProcessor(g GraphInterface) *DeploymentProcessor {
...
func NewStatefulSetProcessor(g GraphInterface) *StatefulSetProcessor {
...
func NewDaemonSetProcessor(g GraphInterface) *DaemonSetProcessor {
...
func NewReplicaSetProcessor(g GraphInterface) *ReplicaSetProcessor {
...
func NewJobProcessor(g GraphInterface) *JobProcessor {
...
func NewCronJobProcessor(g GraphInterface) *CronJobProcessor {
